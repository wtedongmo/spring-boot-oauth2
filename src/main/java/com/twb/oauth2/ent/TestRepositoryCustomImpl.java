...
class TestRepositoryCustomImpl implements TestRepositoryCustom {

    @PersistenceContext
    private EntityManager em;

    @Override
    public Page<TestEntity> filter(LocalDate fromDate, LocalDate toDate, LocalTime fromTime, LocalTime toTime, String text, Double value, Long userId, Pageable p) {
        ...
        TypedQuery<TestEntity> q = em.createQuery(query, TestEntity.class);
